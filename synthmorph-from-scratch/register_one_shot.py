...
def myload(nifti_file,minval=-1000,maxval=1000,out_minval=0,out_maxval=1,target_sz=256):
...
--fixed /cvibraid/cvib2/apps/personal/pteng/github/hello-voxelmorph/simple-elastix/workdir/rv.nii.gz \
--moving /cvibraid/cvib2/apps/personal/pteng/github/hello-voxelmorph/simple-elastix/workdir/tlc.nii.gz \
--moved moved-0.nii.gz \
--model tmp --load-weights mymodels/0600.h5
